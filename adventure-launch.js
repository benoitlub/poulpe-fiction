(function adventureLaunchModule(global) {
  ...
  function deliverableContract(context) {
    ...
    if (context?.seedId === "yael-prospection") return [
      "LIVRABLE UNIQUE DE CETTE AVENTURE:",
      "Produis un kit opérationnel de préqualification commerciale pour Yael, entièrement textuel et directement réutilisable.",
      "Le kit doit contenir, dans cet ordre:",
      "1. Une définition courte du prospect idéal, formulée comme hypothèse à confirmer.",
      "2. Une grille de qualification avec critères, questions de vérification et score total sur 100.",
      "3. Une fiche prospect vierge prête à dupliquer.",
      "4. Dix requêtes de recherche concrètes pour trouver des prospects dans des banques d'informations autorisées.",
      "5. Un tableau CSV ou Markdown avec les colonnes exactes nécessaires au suivi.",
      "6. Trois messages de premier contact: très court, conversationnel et email professionnel.",
      "7. Une procédure de 15 minutes pour qualifier un prospect et décider: prioritaire, à nourrir ou à écarter.",
      "N'invente aucun nom de personne, entreprise, adresse, chiffre, preuve, relation ou coordonnée.",
      "Quand une donnée réelle manque, écris le champ à vérifier au lieu de fabriquer une réponse.",
      "Aucun visuel, aucune consigne Canva, aucun calendrier de publication et aucune prise de contact automatique.",
      "Le résultat doit être exploitable par copier-coller dès son retour dans Récoltes."
    ].join("\n");
